...
function commissions_void($vote, $id,$webroot)
{
     var myxmlhttp;
     ...
     // For example: http://www.websitetoolbox.com/tool/register/USERNAME/create_account
         var url = $webroot+"soap/invoices_items_commissions_items/void/"+$id+"/1";
     }
     else
     {
         var url = $webroot+"soap/invoices_items_commissions_items/void/"+$id+"/0";
     }
     //alert(url);alert($vote);
     XmlHttpGET(myxmlhttp, url);
     //alert(url);
}
function payment_void($vote, $id,$webroot)
{
     var myxmlhttp;
     ...
     // REQUEST URL should be replaced by the URL you need to request
     // For example: http://www.websitetoolbox.com/tool/register/USERNAME/create_account
         var url = $webroot+"soap/commissions_payments/void/"+$id+"/1";
     }
     else
     {
         var url = $webroot+"soap/commissions_payments/void/"+$id+"/0";
     }
     //alert(url);alert($vote);
     XmlHttpGET(myxmlhttp, url);
     //alert(url);
