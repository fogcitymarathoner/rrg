...
function contract_item_activeinactive($vote, $id,$webroot)
{
     var myxmlhttp;
     ...
     // For example: http://www.websitetoolbox.com/tool/register/USERNAME/create_account
         var url = $webroot+"soap/contracts_items/activeinactive/"+$id+"/1";
     }
     else
     {
         var url = $webroot+"soap/contracts_items/activeinactive/"+$id+"/0";
     }
