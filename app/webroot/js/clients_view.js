...
function contract_activeinactive($vote, $id,$webroot)
{
     var myxmlhttp;
     ...
     // For example: http://www.websitetoolbox.com/tool/register/USERNAME/create_account
         var url = $webroot+"soap/clients/Contract_activeinactive/"+$id+"/1";
     }
     else
     {
         var url = $webroot+"soap/clients/Contract_activeinactive/"+$id+"/0";
     }
 ...
 function contract_addendum($vote, $id,$webroot)
 {
      var myxmlhttp;
      ...
      // REQUEST URL should be replaced by the URL you need to request
      // For example: http://www.websitetoolbox.com/tool/register/USERNAME/create_account
          var url = $webroot+"soap/clients/Contract_addendum/"+$id+"/1";
      }
      else
      {
          var url = $webroot+"soap/clients/Contract_addendum/"+$id+"/0";
      }
      //alert(url);alert($vote);
      XmlHttpGET(myxmlhttp, url);
      //alert(url);
