...
<div class="related">
	...
	<?php 
		...
		<tr<?php echo $class;?>>
			...
			<td class="actions">
				<?php echo $html->link(__('Edit', true), array('action'=>'edit_contract_item', $contractsItem['ContractsItem']['id'],'next'=>'manage_contract_items')); ?>
				<?php echo $html->link(__('Add Commissions', true), array('action'=>'add_contract_comm_item', $contractsItem['ContractsItem']['id'])); ?>
				<?php echo $html->link(__('Delete', true), array('action'=>'delete_contract_item', $contractsItem['ContractsItem']['id'],'next'=>'manage_contract_items'), null, sprintf(__('Are you sure you want to delete # %s?', true), $contractsItem['ContractsItem']['id'])); ?>
			</td>
		</tr>
		<tr>
		<td colspan=5>
...
<?php endif; ?>
	...
	<div class="actions">
		<ul>
			...
			<li>
			<?php echo $html->link(__('Add Contract Item', true), array('action'=>'add_contract_item', $clientsContract['ClientsContract']['id'],'next'=>'manage_contract_items')); ?>			
			 </li>
		</ul>
	</div>
</div>
