...
<?php echo $form->create('Clients',array('action'=>'edit_contract_comm_item'));?>
	<fieldset>
	...
	<?php //debug($this->data);
		...
		echo $form->input('ContractsItemsCommissionsItem.modified_user_id',array('name'=>'data[ContractsItemsCommissionsItem][modified_user_id]','type'=>'hidden', 'value'=>$currentUser));
	?>
	</fieldset>
<?php echo $form->end('Submit');?>
</div>

<?php echo $client->contract_actions($contract); ?>
