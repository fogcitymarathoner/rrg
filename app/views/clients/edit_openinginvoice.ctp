...
<div class="clientseditinvoice form">
	...
	<fieldset>
<?php echo $form->create('Clients',array('action'=>'edit_openinginvoice','name'=>'invoice_form'));?>
	<fieldset>
...
<?php echo $html->link(__('Rebuild', true), array('action'=>'rebuild_invoice/'.$this->data['Invoice']['id'].'/next:'.$next)); ?>

</div>
<div class="actions">
	<ul>
		<li><?php echo $html->link(__('Return to Client', true), array('action'=>'view_invoices', $this->data['Client']['Client']['id'])); ?> </li>
	</ul>
</div>
<?php 
//debug($this->data) ;
