...
<h2><?php  __('InvoicesItem');?></h2>
	<dl><?php $i = 0; $class = ' class="altrow"';?>
		...
		<dd<?php if ($i++ % 2 == 0) echo $class;?>>
			<?php echo sprintf('%8.2f',round($invoicesItem['InvoicesItem']['amount'],2)); ?>
			&nbsp;
		</dd>
		...
		<dd<?php if ($i++ % 2 == 0) echo $class;?>>
			<?php echo sprintf('%8.2f',round($invoicesItem['InvoicesItem']['cost'],2)); ?>
			&nbsp;
		</dd>
	</dl>
</div>
...
<div class="related">
	...
	<?php
		...
		<tr<?php echo $class;?>>
			...
			<td><?php echo sprintf("%8.2f",$invoicesItem['amount']);;?></td>
			<td class="actions">
