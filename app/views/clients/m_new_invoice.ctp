...
foreach($keys as $key) {
	echo '<option value='.$this->webroot.'m/clients/newInvoice/'.$client_id.'/2/'.$key.
...
<?php echo $form->create('Clients',array('action'=>'newInvoice/'.$client_id.'/3','name'=>'invoice_form',  'data-ajax'=>"false", 'rel'=>"external"));?>
	<fieldset>
...
<a href="<?php echo $this->webroot.'m/clients/view_invoice_pdf/'.$this->data['Invoice']['id'];?> " rel='external'>Preview</a>
