...
<br>
<br>		<h3><?php echo $client['name']; ?>'s Inactive Searches</h3>
...
<?php echo $this->element('client/searches',array('searches'=>$this->data['ClientsSearch'],'state_id'=>0,'webroot'=>$this->webroot)); ?>
