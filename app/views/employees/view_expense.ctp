...
<div class="actions">
	<ul>
		...
		<li><?php echo $html->link(__('Delete Expense', true), array('action'=>'delete', $expense['Expense']['id']), null, sprintf(__('Are you sure you want to delete # %s?', true), $expense['Expense']['id'])); ?> </li>
