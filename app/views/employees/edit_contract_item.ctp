...
<?php echo $form->create('Employees',array('action'=>'edit_contract_item_submit','id'=>'addedit_contract_item','onsubmit'=>'return validateForm()'));?>
	<fieldset>
...
<?php 
			...
			$res .= '</div>';
			echo $res;
echo $client->contract_actions($this->data['ClientsContract']); 
?>