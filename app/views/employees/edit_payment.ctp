...
<?php echo $form->create('Employees',array('action'=>'edit_payment'));  
?>
	<fieldset>
	...
	<?php
		...
		echo $form->input('EmployeesPayment.next',array('type'=>'hidden','value'=>$next));
...
<div class="actions">
	<ul>
		<li><?php echo $html->link(__('Return to Employee', true), array('action'=>$next, $this->data['Employee']['id'])); ?> </li>
	</ul>
</div>