...
<?php echo $form->create('Employee');?>
    <fieldset>
        <legend><?php __('Edit Letter');?></legend>

        <?php
                echo $form->input('EmployeesLetter.id',array('type'=>'hidden'));
                ?>
        <?php
...
<?php echo $form->input('EmployeesLetter.date', array('class'=>'datepicker','type'=>'text',
        'label'=>False, 'size'=>9, 'autocomplete'=>'off', 'value'=>$this->data['EmployeesLetter']['date'])); ?>
<br>
