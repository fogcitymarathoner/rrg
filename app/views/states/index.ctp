<div class="states index">
	...
	<tr>
			<th><?php echo $this->Paginator->sort('post_ab');?></th>
			<th><?php echo $this->Paginator->sort('capital');?></th>
			<th><?php echo $this->Paginator->sort('date');?></th>
			<th><?php echo $this->Paginator->sort('flower');?></th>
			<th><?php echo $this->Paginator->sort('name');?></th>
			<th><?php echo $this->Paginator->sort('state_no');?></th>
	...
	?>
	<tr<?php echo $class;?>>
		<td><?php echo $state['State']['post_ab']; ?>&nbsp;</td>
		<td><?php echo $state['State']['capital']; ?>&nbsp;</td>
		<td><?php echo $state['State']['date']; ?>&nbsp;</td>
		<td><?php echo $state['State']['flower']; ?>&nbsp;</td>
		<td><?php echo $state['State']['name']; ?>&nbsp;</td>
		<td><?php echo $state['State']['state_no']; ?>&nbsp;</td>
