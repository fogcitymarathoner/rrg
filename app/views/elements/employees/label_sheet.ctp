...
{
?>
<div><h2 class='employees-page-title'><?php __('Active Employees');?></h2></div>
<?php } else { ?>
<div><h2 class='employees-page-title'><?php __('Inactive Employees');?></h2></div>
<?php }?>
...
<div>sort by <?php echo $paginator->sort('firstname');?><?php echo $paginator->sort('lastname');?></div>
        <div id="tablecontainer">
          <?php echo $this->element('employees/web_label_sheet',array('employees'=>$employees,'webroot'=>$this->webroot));?>
        </div>
<div id='footer'>
    <div class="paging">
