...
<div data-role="header">
    <div id='buttons'>
        ...
        <a href="<?php echo $this->webroot?>m/clients/view_managers/<?php echo $clientD['id']?>"  rel="external" data-role="button" data-inline="true" data-icon="pencil_16x16">Managers</a>
