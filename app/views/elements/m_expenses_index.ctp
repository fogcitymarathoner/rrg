...
<a href="<?php echo $this->webroot?>m/expenses/view_expenseCategory/<?php echo $expense['ExpensesCategory']['id']?>" data-rel="external" data-inline="true" data-role='button' data-icon='check'><?php echo __($expense['ExpensesCategory']['name'], true)?> </a>
</div>
