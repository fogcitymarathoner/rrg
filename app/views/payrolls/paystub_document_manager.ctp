...
<?php
			...
			<td>
                <a href="https://cake.rocketsredglare.com/doc/board/reply/<?php echo $pay['Employee']['Profile']['released_cat_id'];?>/<?php echo $pay['Employee']['Profile']['released_cat_thread_id'];?>/" target="_blank">Crypto For Employee</a>

                <a href="https://cake.rocketsredglare.com/doc/board/reply/<?php echo $pay['Employee']['Profile']['internal_cat_id'];?>/<?php echo $pay['Employee']['Profile']['internal_cat_thread_id'];?>/" target="_blank">Internal For Staff</a>
