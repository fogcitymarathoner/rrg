...
<?php echo $form->create('Expense',array('action'=>'edit_exp'));?>
	<fieldset>
...
<div class="actions">
	<ul>
		<li><?php echo $html->link(__('Delete', true), array('action'=>'delete_expense', $form->value('Expense.id')), null, sprintf(__('Are you sure you want to delete # %s?', true), $form->value('Expense.id'))); ?></li>
