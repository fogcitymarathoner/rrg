...
<div class="actions">
	<ul>
		<li><?php echo $html->link(__('Edit Expense', true), array('action'=>'edit', $expense['Expense']['id'])); ?> </li>
		<li><?php echo $html->link(__('Delete Expense', true), array('action'=>'delete_expense', $expense['Expense']['id']), null, sprintf(__('Are you sure you want to delete # %s?', true), $expense['Expense']['id'])); ?> </li>
		<li><?php echo $html->link(__('List Expenses', true), array('action'=>'index')); ?> </li>
		<li><?php echo $html->link(__('New Expense', true), array('action'=>'add')); ?> </li>
