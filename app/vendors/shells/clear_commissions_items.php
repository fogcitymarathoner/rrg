...
class ClearCommissionsItemsShell extends Shell {
    ...
    function main() {
        ...
        /* clear all commissions items associated wit hcleared  invoices

        */
    	$invCIModel = new InvoicesItemsCommissionsItem;
    	$invCIModel->clear_commissions_items();
        /*
         *  Clear all taga with all commissions items cleared
         */
        $tagModel = new CommissionsReportsTag ;
        $tagModel->clear_commissions_tags_release();
