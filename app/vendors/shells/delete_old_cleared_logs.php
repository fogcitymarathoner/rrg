...
class DeleteOldClearedLogsShell extends Shell {
    ...
    function main() {
        ...
        App::import('Model', 'InvoicesTimecardReminderLog');
        App::import('Model', 'InvoicesPostLog');
        App::import('Model', 'InvoicesTimecardReceiptLog');
    	App::import('Controller', 'CommissionsReports');
        $logModel = new InvoicesPostLog;
        $logModel->delete_old_cleared();
        $logModel = new InvoicesTimecardReminderLog;
        $logModel->delete_old_cleared();
        $logModel = new InvoicesTimecardReceiptLog;
        $logModel->delete_old_cleared();
    	exit;
    	// Generate Reminders
